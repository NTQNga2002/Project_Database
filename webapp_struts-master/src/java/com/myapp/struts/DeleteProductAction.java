 ...
 * @author admin
 */
public class DeleteProductAction extends org.apache.struts.action.Action {
    ...
    public ActionForward execute(ActionMapping mapping, ActionForm form,
            ...
            throws Exception {
        DeleteProductForm formBean =(DeleteProductForm) form;
        String id = formBean.getId();
        String name = DropProduct(id);
        if (name!=null){
    ...
    public String DropProduct(String id){
        String name = null;
